...
class _NuevoMensajeState extends State<NuevoMensaje> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _getTextField(9, "Titula la publicación", "Título",
                              _titleController),
                          const SizedBox(
                            height: 20.0,
                          ),
                          _getTextField(6, "Descripción de la publicación",
                              "Descripción", _messageController),
  ...
  Widget _getTextField(int maxLines, String hint, String label,
